...
- Meaning e4_entropy_h measures how random/unpredictable are the Client Hello / Server Hello.
...
**e1_alg_suite_mlkem1024:** From the same algorithm family as the previous one (mlkem768), but using a parameter set that targets a higher security level (roughly comparable to AES-256).
