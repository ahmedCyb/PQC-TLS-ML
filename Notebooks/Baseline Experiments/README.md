...
the model took 6.04 seconds to train 0.03 secoonds to test, almost perfect results on the normal class with 99 precision and 98 recall. 89 precision and 90 recall on the anomaly class. we got good balance between them. [Chech out the full notebook](41_catboost_original_1.ipynb)
